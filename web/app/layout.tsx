      ...
      <body>
        ...
        <footer>
          ...
          <p>
            ...
            &nbsp;&middot;&nbsp;
            <a href="https://paypal.me/shubtheone" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', textDecoration: 'none' }}>
              Support me :)
            </a>
            &nbsp;&middot;&nbsp;
            <a href="https://buymeacoffee.com/shubtheone" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', textDecoration: 'none' }}>
              ☕
            </a>
          </p>
        </footer>
